...
SCREEN_HEIGHT = 480
GRID_SIZE = 20
CELLS_WIDTH = SCREEN_WIDTH // GRID_SIZE
CELLS_HEIGHT = SCREEN_HEIGHT // GRID_SIZE
...
class Apple(GameObject):
    ...
    def __init__(self, snake_positions: Optional[List[Tuple[int, int]]] = None) -> None:
        """
        ...
        super().__init__((0, 0), self.body_color)
        self.randomize_position(snake_positions)

    def randomize_position(
        self, snake_positions: Optional[List[Tuple[int, int]]] = None
    ) -> None:
        """
...
class Snake(GameObject):
    ...
    def move(self) -> bool:
        ...
        Returns:
            True при столкновении с собой, False при успешном движении.
        """
